                ...
                <div class="isolate flex flex-auto flex-col overflow-y-auto" style="max-height: 750px;">
                    <header class="flex flex-none items-center justify-between border-b border-gray-200 px-6 py-4">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">
                            <time datetime="{{ now()->format('Y-m') }}">{{ now()->format('F Y') }}</time>
                        </h1>
                        <!-- Header controls -->
                    </header>
                                ...
                                <div class="grid grid-cols-7 text-sm leading-6 text-gray-500 sm:hidden">
                                    @for ($i = 0; $i < 7; $i++)
                                        ...
                                        <button type="button" class="flex flex-col items-center pb-3 pt-2">
                                            {{ $day->format('D') }} <span class="mt-1 flex h-8 w-8 items-center justify-center font-semibold text-gray-900">{{ $day->format('d') }}</span>
                                        </button>
                                    @endfor
                                </div>
                                ...
                                <div class="-mr-px hidden grid-cols-7 divide-x divide-gray-100 border-r border-gray-100 text-sm leading-6 text-gray-500 sm:grid">
                                    ...
                                    @for ($i = 0; $i < 7; $i++)
                                        ...
                                        <div class="flex items-center justify-center py-3">
                                            <span>{{ $day->format('D') }} <span class="items-center justify-center font-semibold text-gray-900">{{ $day->format('d') }}</span></span>
                                        </div>
                                    @endfor
                                </div>
                            </div>
                                ...
                                <div class="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-gray-100 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                    ...
                                    <div class="py-1" role="none">
                                        <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                            role="menuitem" tabindex="-1" id="menu-0-item-1">Go to today</a>
                                    </div>
                                    <div class="py-1" role="none">
                                        <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                            role="menuitem" tabindex="-1" id="menu-0-item-2">Day view</a>
                                        <a href="{{ route('dashboard') }}"
                                            class="text-gray-700 block px-4 py-2 text-sm" role="menuitem"
                                            tabindex="-1" id="menu-0-item-3">Week view</a>
                                        <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                            role="menuitem" tabindex="-1" id="menu-0-item-4">Month view</a>
                                        <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                            role="menuitem" tabindex="-1" id="menu-0-item-5">Year view</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-auto">
                                ...
                                <div class="grid flex-auto grid-cols-1 grid-rows-1">
                                    ...
                                    <ol class="col-start-1 col-end-2 row-start-1 grid grid-cols-1 sm:grid-cols-7 sm:pr-8"
                                        ...
                                        <li class="relative mt-px hidden sm:col-start-6 sm:flex"
                                            style="grid-row: 30 / span 24">
                                            <a href="#"
                                                ...
                                                <p class="order-1 font-semibold text-gray-700">Meeting with design team
                                                    at
                                                    Disney</p>

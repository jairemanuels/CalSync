                ...
                <div class="isolate flex flex-auto flex-col overflow-y-auto" style="max-height: 750px;">
                    <header class="flex flex-none items-center justify-between border-b border-gray-200 px-6 py-4">
                        ...
                        <div class="flex items-center space-x-2"> <!-- Add space between buttons if needed -->
                            <button id="sub-week" type="button"
                            ...
                            <button id="add-week" type="button"
...
<script>
    ...
    $(document).ready(function() {
        function updateWeek(newDate) {
            ...
            // Optionally, you can update the URL without reloading the page
            history.pushState({}, '', `?date=${newDate}`);

            // Reload the page to update the events (optional)
            location.reload();
        }

        ...
        <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                        ...
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item {{ request()->is('/') ? 'active' : '' }}">
                                <a class="nav-link {{ request()->is('/') ? 'active' : '' }}" href="/">
                                    ...
                                    <span class="sidenav-normal"> Personal Calendar </span>
                                </a>
                            </li>
                        </ul>
                        <ul class="nav ms-4 ps-3">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">TEAMS</h6>
                </li>
                {{-- <li class="nav-item">
                    <a class="nav-link"
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#applicationsExamples" class="nav-link "
                        ...
                        <span class="nav-link-text ms-1">Shared Calendars</span>
                    </a>
                    ...
                    {{-- create new team --}}
                    <a href="/projects/create" class="nav-link " aria-controls="applicationsExamples" role="button"
                        aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                        ...
                        <span class="nav-link-text ms-1">Create new team</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{$currentPage === 'calendar' ? $userTeamMember->where('team_id', $currentUuid)->first()->team->name : ' ' }}</h6>
                </li>
                <li class="nav-item">
                        ...
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item ">
                                <a class="nav-link "
                                    ...
                                    <span class="sidenav-normal"> Coming soon </span>
                                </a>
                            </li>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    @if (!auth()->user())
                        {
                        <ul class="navbar-nav" <ul class="navbar-nav justify-content-end">

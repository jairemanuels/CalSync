<div>
    <div class="col-12 text-center">
        <h3 class="mt-5">Lets setup your shared calendar</h3>
                                ...
                                <div class="card-body text-start">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" wire:model="name" class="form-control" id="name"
                                            placeholder="The Overbooked Bunch">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model="description" class="form-control"
                                            id="domain"
                                            placeholder="Organizing the mayhem so this bunch stays (mostly) on schedule!">
                                    </div>

                                    <div class="form-group">
                                        <label for="is_private">Private</label>
                                        <p class="text-secondary font-weight-normal text-sm">Public calendars
                                            allow everyone with a link to view your calendar</p>
                                        <select class="form-control" wire:model="private" id="private">
                                    ...
                                    <div class="form-group">
                                        <label for="is_private">Collaborative</label>
                                        <p class="text-secondary font-weight-normal text-sm">Collaborative calendars
                                            allow everyone to sync-in their own events</p>
                                        <select class="form-control" wire:model="collaborative" id="collaborative">
                                            <option value="false">No</option>
                                            <option value="true">Yes</option>
                                        </select>
                                    </div>
                                        ...
                                        <select class="form-control" wire:model="timezone" id="timezone-selection">
                                            @foreach (\App\Facades\World::timezones() as $key => $timezone)
                                                <option value="{{ $timezone }}"
                                                    @if ($timezone == 'Europe/Amsterdam') selected @endif>
                                                    {{ $timezone }}</option>
                                            @endforeach
                                        </select>
                                        @error('timezone')
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <select class="form-control" wire:model="country" id="country-selection">
                                            @foreach (\App\Facades\World::countries() as $key => $country)
                                                <option value="{{ $key }}"
                                                    @if (request()->header('cf-ipcountry', 'NL') == $key) selected @endif>
                                                    {{ $country }}</option>
                                            @endforeach
                                        </select>
                                        @error('country')
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" wire:model="region" class="form-control"
                                                    id="region" placeholder="Province / State / Region">
                                                @error('region')
                                                    <p class="text-sm text-danger mb-2">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <button type="button" wire:click="createTeamCalendar"
                                            class="btn bg-gradient-dark">Get Started</button>
                                    </div>
                                    <div>
                                        <a href='/' class="text-secondary text-sm text-end">Do this later</a>
                                    </div>
                                </div>
                        </form>

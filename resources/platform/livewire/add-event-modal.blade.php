            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" wire:model="startsAt" class="form-control" id="starts_at" placeholder="Starts At">
                    </div>
                    @if(!$allDay)
                    <div class="form-group">
                        <label for="ends_at">Ends at</label>
                        <input type="datetime-local" wire:model="endsAt" class="form-control" id="ends_at" placeholder="Ends At">
                    </div>
                    @endif
                    <div class="form-check form-switch">
                        <input class="form-check-input" wire:model="allDay" value="1" type="checkbox" id="flexSwitchCheckDefault" @if($allDay) checked="" @endif>
